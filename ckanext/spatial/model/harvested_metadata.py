...
class MappedXmlDocument(MappedXmlObject):
    ...
    def get_xml_tree(self):
        ...
        if self.xml_tree is None:
            ...
            # log.info(" get tree %s - %s ",parser,xml_str)
...
class ISOContactInfo(ISOElement):
    elements = [
        # email
        ISOElement(
            name="email",
            ...
            multiplicity="0..1",  #TODO: modify to account for multiple e-mails
        ),
        #SMR addition 
        ...
        ISOElement(
            ...
            multiplicity="0..1",  # Modify to allow multiple phone number later...
        ),
...
class ISOResponsibleParty(ISOElement):
    ...
    elements = [
        ...
        ISOElement(
            name="role-codelist",
            search_paths=[
                "gmd:role/gmd:CI_RoleCode/@codelist",
            ],
            multiplicity="0..1",
        ), 
        #end smr addition
...
class ISODocument(MappedXmlDocument):
    ...
    elements = [
        ...
        ISOElement(
            ...
            search_paths=[
                "gmd:metadataStandardName/gco:CharacterString/text()"
            ],
            multiplicity="0..1",
        ),
        ISOElement(
            ...
            search_paths=[
                "gmd:metadataStandardVersion/gco:CharacterString/text()"
            ],
            multiplicity="0..1",
        ),
        ...
        # remove metadata contact from the search_paths for the resource POC
        ISOResponsibleParty(
		 ...
		 "gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:pointOfContact/gmd:CI_ResponsibleParty",
        ...
        #progress code
        ISOElement(
            name="progress",  #alt name is status, can a second name be added?
            search_paths=[
        ...
        #progress code in status key; add for compatibility with NGDS xml_reader processing. note multiplicity here is 
        # 0..1, but in 19115 model is 0..*
        ISOElement(
            name="status",  #alt name is status, can a second name be added?
            search_paths=[
                "gmd:identificationInfo/gmd:MD_DataIdentification/gmd:status/gmd:MD_ProgressCode/@codeListValue",
                "gmd:identificationInfo/srv:SV_ServiceIdentification/gmd:status/gmd:MD_ProgressCode/@codeListValue",
                "gmd:identificationInfo/gmd:MD_DataIdentification/gmd:status/gmd:MD_ProgressCode/text()",
        ...
        #access constraints restriction codes
        ISOElement(
        ...
        # 2015-10-14 keep for compatibility with NGDS ckext-metadata/ckanext/harvest/xml_reader.py
        ISOResourceLocator(
        ...
        # SMR 2015-10-14; add this seciton to harvested_metadata.py. Note that the processor for ISOElement will break after the first value found on any of the paths.
