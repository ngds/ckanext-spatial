(function (ckan, jQuery) {
  ...
  ckan.commonLeafletMap = function (container,
      ...
      var mapConfig = mapConfig || {type: 'mapbox'};
          //GH added 7/15/16 
          mapConfig.type = 'mapbox';
      ...
      if (mapConfig.type == 'mapbox') {
          // MapBox base map
          /* -- not needed since its in the url 
          ...
          */
          ...
          baseLayerUrl = 'https://api.tiles.mapbox.com/v4/mapbox.outdoors/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiZ2FyeWh1ZG1hbiIsImEiOiJjaW14dnV2ZzAwM2s5dXJrazlka2Q2djhjIn0.NOrl8g_NpUG0TEa6SD-MhQ',
